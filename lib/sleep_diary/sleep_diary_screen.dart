...
4. 최종적으로 깨기 전 중간에 몇 번이나 깼습니까?: ${_controller4.text.trim()}
...
9. 꿈을 꾸었습니까? 꾸었다면 어떤 내용이었습니까?: ${sanitizeText(_controller9.text)}
10. 수면과 관련해서 달리 관찰된 내용이 있다면 적어주세요: ${sanitizeText(_controller10.text)}
11. 직장이나 가정에서 겪은 어려운 상황 등 수면에 영향을 미쳤을지도 모른다고 생각되는 사건이 낮에 있었다면 적어주세요: ${sanitizeText(_controller11.text)}
''';
